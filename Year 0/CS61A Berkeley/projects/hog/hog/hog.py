...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    curr_rolls, curr_score, flag = 0, 0, 0
    while curr_rolls < num_rolls:
        a = dice()
        if a != 1: curr_score += a
        else: flag = 1
        curr_rolls += 1
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    score_cubed = cube(score)
    even_index, even_sum, odd_index, odd_sum = score_cubed, 0, score_cubed, 0
    while even_index > 0:
        odd_sum += odd_index % 10
        odd_index //= 100
        even_sum += (even_index // 10) % 10
        even_index //= 100
    return 1 + abs(odd_sum - even_sum)        
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    if str_excitement[0] == str_excitement[len(str_excitement) - 1]: return True
    else: return False
    # END PROBLEM 4
